    ...
    <div className="min-h-screen bg-background">
      ...
      <main>
        <HeroSectionPersonalized 
          onCTA={handleCTA}
          headline="O fim do planejamento que nunca sobrevive à segunda-feira."
          subheadline="A maioria falha porque planeja para uma vida ideal. O Planejador Realista PDI cria agendas à prova de imprevistos, com margem de segurança automática."
          ctaText="👉 Criar minha Rotina Blindada"
        />
