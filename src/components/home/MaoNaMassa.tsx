          ...
          <div ref={formRef}>
            ...
            <div className="space-y-2">
              ...
              <Link 
                ...
                className="text-xs text-wine hover:text-wine/80 hover:underline mt-1 inline-flex items-center gap-2"
              >
  ...
  if (embedded) {
    return (
      <div className="w-full max-w-full overflow-hidden min-w-0">
        ...
        <p className="text-sm text-muted-foreground mb-3 sm:mb-4">Transforme seus objetivos em metas executáveis</p>
        {content}
        {modals}
      </div>
    );
