...
const Index = () => {
  ...
  return (
    <div className="min-h-screen bg-[#1a1a1a]">
        ...
        <div className="container mx-auto max-w-4xl">
          ...
          <div className="space-y-6 max-w-2xl mx-auto">
            <div className="flex items-start gap-4">
              <div className="w-2 h-2 rounded-full bg-gray-500 mt-2.5 flex-shrink-0" />
              <p className="text-base sm:text-lg text-gray-400 leading-relaxed">
                Você anota tudo, usa planners e apps, mas a sensação de sobrecarga não passa.
              </p>
            </div>
            ...
            <div className="flex items-start gap-4 bg-[#1a1a1a] rounded-xl p-5 border border-red-500/30">
              ...
              <div>
                <p className="font-semibold text-white mb-1">O Erro:</p>
                <p className="text-gray-400">
                  Você está gerenciando o <strong className="text-white">Ruído</strong> (tarefas urgentes e aleatórias).
                </p>
              </div>
            </div>
            ...
            <div className="flex items-start gap-4 bg-[#1a1a1a] rounded-xl p-5 border border-[#d4a853]/30">
              ...
              <div>
                <p className="font-semibold text-white mb-1">A Solução:</p>
                <p className="text-gray-400">
                  Você precisa gerenciar o <strong className="text-[#d4a853]">Essencial</strong> (quem você decidiu ser).
                </p>
              </div>
            </div>
            ...
            <div className="text-center pt-4">
              <p className="text-lg sm:text-xl text-white font-medium">
                O PDI não é para fazer mais coisas.{" "}
                <span className="text-[#d4a853]">É para garantir que você faça as coisas certas.</span>
              </p>
            </div>
          </div>
        </div>
        ...
        <div className="container mx-auto max-w-6xl">
          <div className="text-center mb-10 sm:mb-14">
            ...
            <p className="text-gray-400 max-w-2xl mx-auto text-base sm:text-lg">
              A maioria dos apps espera que você organize tudo sozinho. O PDI guia o processo.
            </p>
          </div>
      ...
      {/* ============================================================ */}
      {/* 4. SEÇÃO "O QUE É" - Funcionalidades */}
      {/* ============================================================ */}
      <section className="py-12 sm:py-16 px-4 bg-[#222222]">
        <div className="container mx-auto max-w-4xl">
