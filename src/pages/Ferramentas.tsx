...
const Ferramentas = () => {
  ...
  return (
    <div className="min-h-screen bg-gradient-subtle">
      <header className="bg-primary border-b border-primary/80 shadow-elegant sticky top-0 z-10">
        <div className="container mx-auto px-4 py-4">
          <div className="flex items-center justify-between gap-2">
            <div className="flex items-center gap-2 sm:gap-3 min-w-0">
              <Wrench className="w-5 h-5 sm:w-6 sm:h-6 text-primary-foreground flex-shrink-0" />
              <h1 className="text-lg sm:text-2xl font-bold text-primary-foreground truncate">Ferramentas de Desenvolvimento</h1>
            </div>
