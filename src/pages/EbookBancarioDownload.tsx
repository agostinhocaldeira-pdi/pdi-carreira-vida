...
import { CheckCircle, Download, XCircle, Loader2, Building2, ArrowRight } from "lucide-react";
import { supabase } from "@/integrations/supabase/client";
import Logo from "@/components/Logo";

const EbookBancarioDownload = () => {
  ...
  const handleDownload = () => {
    window.open("/ebooks/manual-do-bancario.pdf", "_blank");
  };
        ...
        {status === "success" && (
          <>
            ...
            <CardContent className="space-y-4">
              <div className="bg-blue-500/5 p-6 rounded-xl border-2 border-blue-500/20">
                <Building2 className="w-12 h-12 text-blue-600 mx-auto mb-3" />
                <h3 className="font-semibold mb-2">Manual do Bancário</h3>
                <p className="text-sm text-muted-foreground mb-4">
                  Por Agostinho Caldeira
                </p>
                <Button onClick={handleDownload} className="w-full bg-blue-600 hover:bg-blue-700" size="lg">
...
export default EbookBancarioDownload;
