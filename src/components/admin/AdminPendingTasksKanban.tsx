...
import { useAdminPendingTasks, AdminPendingTask } from "@/hooks/useAdminPendingTasks";
...
export const AdminPendingTasksKanban = () => {
  const isMobile = useIsMobile();
  const { tasks, loading, createTask, moveTask, deleteTask, getTasksByStatus } = useAdminPendingTasks();
...
export default AdminPendingTasksKanban;
