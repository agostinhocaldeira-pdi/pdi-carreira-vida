...
const ptTranslations = {
  ...
  planoDeVida: {
    ...
    registerNewObjective: 'Atenção: "Quem muito quer, pouco consegue!" (Tenha no máximo 3 objetivos por vez)',
...
const enTranslations = {
  ...
  planoDeVida: {
    ...
    registerNewObjective: 'Attention: "He who wants too much, achieves little!" (Have at most 3 objectives at a time)',
