...
interface SwotScientificModalProps {
  open: boolean;
  onOpenChange: (open: boolean) => void;
}

const SwotScientificModal: React.FC<SwotScientificModalProps> = ({ open, onOpenChange }) => {
  return (
    <Dialog open={open} onOpenChange={onOpenChange}>
      <DialogContent className="max-w-2xl max-h-[90vh]">
        <DialogHeader>
          <DialogTitle className="text-xl font-semibold text-primary">
            A importância de conhecer suas forças e fraquezas
          </DialogTitle>
        </DialogHeader>
...
export default SwotScientificModal;
